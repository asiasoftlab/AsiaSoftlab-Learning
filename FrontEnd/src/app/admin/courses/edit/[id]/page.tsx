    ...
    try {
      ...
      if (course.lessons && Array.isArray(course.lessons)) {
        ...
        const mappedLessons = sorted.map(l => ({
          ...l,
          youtubeUrl: l.youtubeVideoId ? `https://youtube.com/watch?v=${l.youtubeVideoId}` : "",
    ...
    <div className="space-y-6 animate-fade-in pb-12">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Update details, thumbnail, and curriculum.</p>
        </div>
      </div>
            ...
            <div className="space-y-2">
              ...
              <div className="border-2 border-dashed border-slate-300 rounded-xl overflow-hidden relative bg-slate-50 transition-all hover:bg-slate-100 flex flex-col items-center justify-center min-h-[200px]">
                {thumbnailPreview || existingThumbnailUrl ? (
                  <>
                    <Image src={thumbnailPreview || existingThumbnailUrl || ""} alt="Preview" fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover" />
